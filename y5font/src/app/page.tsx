                  ...
                  <div className="inline-flex py-0.5 px-2 w-fit items-center justify-center text-xs text-neutral-50 font-semibold bg-dunamuMain rounded">
                    ...
                    <div className='flex items-center gap-2'>
                      <Link href="/article/write">
                        <Button variant={'primary'} size={'lg'} className="w-[140px] mt-6 rounded bg-upBitLightBlue">기사 작성하기</Button>
                      </Link>
                      <Link href="/blog/write">
                        <Button variant={'primary'} size={'lg'} className="w-[140px] mt-6 rounded bg-upBitLightBlue">블로그 글쓰기</Button>
                      </Link>
                    </div>
