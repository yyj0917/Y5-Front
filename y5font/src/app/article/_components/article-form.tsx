...
export function ArticleForm() {
  ...
  const fields: Array<{
    ...
    { name: "textarea", label: "Description", type: "textarea", placeholder: "Please write what you want to write. The form is free." },
  ...
  return (
    <Form {...form}>
      ...
      {fields.map((field) => (
        ...
        <Button type="submit" className="rounded-xl bg-upBitLightBlue">Submit</Button>
      </form>
    </Form>
  )
}
